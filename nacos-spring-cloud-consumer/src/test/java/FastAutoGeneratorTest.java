...
public class FastAutoGeneratorTest {
     ...
     * 数据源配置
     */
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig.Builder("jdbc:mysql://192.168.23.239:3306/upsuser", "root", "");

    /**
     * 执行 run
     */
    public static void main(String[] args) {
        String projectPath = System.getProperty("user.dir")+"\\nacos-spring-cloud-consumer";
...
//                )
                // 策略配置
                .strategyConfig(builder -> builder.addInclude("report")
                        .entityBuilder()
                        .enableLombok()
                        .enableActiveRecord()
